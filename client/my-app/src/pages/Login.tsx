...
export const Login = () => {
  ...
  const submitSignUp = (e: FormEvent) => {
    ...
    if (firstName && lastName && email && password && xpLevelId && categoryId) {
      signUp({
        firstName,
        lastName,
        email,
          ...
          <section className="section">
            ...
            <form onSubmit={submitSignIn}>
              ...
              <span>
                ...
                <button className="forgot" onClick={() => setDisplay("forgotPassword")}>
                  Forgot password?
                </button>
              </span>
              ...
              <button className="accountSignIn" onClick={() => setDisplay("signUp")}>
        ...
        >
          <section className="section" id="section2">
            ...
            <form onSubmit={submitSignUp}>
              ...
              <br />
              <select className="dropDown" name="expLevel" id="expLevel" ref={xpLevelIdRef}>
                <option value="0">Experience Level</option>
                {xpLevels.map((xpLevel) => (
                  <option key={xpLevel.xpLevelId} value={xpLevel.xpLevelId}>
                    {xpLevel.xpLevelName}
                  </option>
                ))}
              </select>
              <br />
              <select className="dropDown" name="careerPath" id="careerPath" ref={categoryIdRef}>
              ...
              <button className="accountSignIn" onClick={() => setDisplay("signIn")}>
        ...
        >
          <section className="section">
            ...
            <form action="">
              ...
              <button className="signIn" id="cancel" onClick={() => setDisplay("signIn")}>
                Cancel
              </button>
