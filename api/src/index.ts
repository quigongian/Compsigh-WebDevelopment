...
api.get("/checkin", checkInController.getPaginatedCheckIns);
api.get("/checkin/:checkInId", checkInController.getCheckIn);
api.post("/checkin", checkInController.makeCheckIn);
